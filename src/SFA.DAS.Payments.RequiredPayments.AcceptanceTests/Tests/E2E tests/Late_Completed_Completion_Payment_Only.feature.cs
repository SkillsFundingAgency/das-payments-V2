...
#line hidden
            ...
            table17.AddRow(new string[] {
                        ...
                        "600"});
#line 27
 testRunner.And("the following historical contract type 2 On Programme Learning payments exist:", ((string)(null)), table17, "And ");
#line hidden
        }
...
#line 60
 testRunner.Then("the required payments component will generate the following contract type 2 Compl" +
                    "etion (TT2) payable earnings:", ((string)(null)), table18, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
