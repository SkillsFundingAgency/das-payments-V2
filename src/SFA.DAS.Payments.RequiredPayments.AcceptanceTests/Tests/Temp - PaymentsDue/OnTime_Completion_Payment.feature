...
Scenario Outline: Contract Type 2 On programme payments
	...
	Then the payments due component will generate the following contract type 2 transaction type Learning_1 payable earnings:
...
Scenario Outline: Contract Type 2 completion payment
	...
	Then the payments due component will generate the following contract type 2 transaction type Completion_2 payable earnings:
	| LearnRefNumber | Ukprn | PriceEpisodeIdentifier | Period | ULN   | TransactionType    | Amount   | SfaContributionPercentage |
