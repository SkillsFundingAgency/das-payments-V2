...
#line hidden
            ...
            table56.AddRow(new string[] {
                        ...
                        "continuing"});
#line 8
 testRunner.And("the following course information:", ((string)(null)), table56, "And ");
#line hidden
...
#line 12
 testRunner.And("the following contract type 2 on programme earnings for periods 1-12 are provided" +
                    " in the latest ILR for the academic year 1718:", ((string)(null)), table57, "And ");
#line hidden
        }
...
#line hidden
            ...
            table58.AddRow(new string[] {
                        ...
                        string.Format("{0}", amount)});
#line 21
 testRunner.And("the following historical contract type 2 on programme payments exist:", ((string)(null)), table58, "And ");
#line 26
...
#line 28
 testRunner.Then("the payments due component will generate the following contract type 2 payable ea" +
                    "rnings:", ((string)(null)), table59, "Then ");
#line hidden
