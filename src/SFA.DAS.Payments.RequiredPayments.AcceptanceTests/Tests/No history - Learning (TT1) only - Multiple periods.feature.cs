...
namespace SFA.DAS.Payments.RequiredPayments.AcceptanceTests.Tests
{
    ...
    [NUnit.Framework.DescriptionAttribute("No history - Learning (TT1) only - Multiple periods")]
    public partial class NoHistory_LearningTT1Only_MultiplePeriodsFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "No history - Learning (TT1) only - Multiple periods.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "No history - Learning (TT1) only - Multiple periods", "R02 - First payment including previous month", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
            ...
            table45.AddRow(new string[] {
                        ...
                        "600"});
#line 9
 testRunner.And("the payments due component generates the following contract type 2 payments due:", ((string)(null)), table45, "And ");
#line hidden
        }
