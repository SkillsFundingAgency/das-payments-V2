...
#line hidden
            ...
            table115.AddRow(new string[] {
                        ...
                        "Completed"});
#line 13
 testRunner.And("the following course information:", ((string)(null)), table115, "And ");
#line hidden
...
#line 17
 testRunner.And("the following contract type 2 on programme earnings for periods 1-12 are provided" +
                    " in the latest ILR for the academic year 1718:", ((string)(null)), table116, "And ");
#line hidden
...
#line 21
 testRunner.And("the following contract type 2 on programme earnings for periods 13 are provided i" +
                    "n the latest ILR for the academic year 1718:", ((string)(null)), table117, "And ");
#line hidden
        }
...
#line hidden
            ...
            table118.AddRow(new string[] {
                        ...
                        string.Format("{0}", amount)});
#line 36
 testRunner.And("the following historical contract type 2 on programme payments exist:", ((string)(null)), table118, "And ");
#line 51
...
#line 53
 testRunner.Then("the payments due component will generate the following contract type 2 payable ea" +
                    "rnings:", ((string)(null)), table119, "Then ");
#line hidden
...
#line 75
 testRunner.Then("the payments due component will generate the following contract type 2 payable ea" +
                    "rnings:", ((string)(null)), table120, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 87
 testRunner.Then("the payments due component will generate the following contract type 2 payable ea" +
                    "rnings:", ((string)(null)), table121, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
