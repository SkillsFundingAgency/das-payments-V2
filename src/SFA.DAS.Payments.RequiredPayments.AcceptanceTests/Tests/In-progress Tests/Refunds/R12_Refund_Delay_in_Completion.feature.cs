...
#line hidden
            ...
            table146.AddRow(new string[] {
                        ...
                        "continuing"});
#line 10
 testRunner.And("the following course information:", ((string)(null)), table146, "And ");
#line hidden
...
#line 14
 testRunner.And("the following contract type 2 on programme earnings for periods 1-12 are provided" +
                    " in the latest ILR for the academic year 1718:", ((string)(null)), table147, "And ");
#line hidden
        }
...
#line hidden
            ...
            table148.AddRow(new string[] {
                        ...
                        string.Format("{0}", amount)});
#line 28
 testRunner.And("the following historical contract type 2 on programme payments exist:", ((string)(null)), table148, "And ");
#line 42
...
#line 83
 testRunner.Then("the payments due component will generate the following contract type 2 payable ea" +
                    "rnings:", ((string)(null)), table150, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
