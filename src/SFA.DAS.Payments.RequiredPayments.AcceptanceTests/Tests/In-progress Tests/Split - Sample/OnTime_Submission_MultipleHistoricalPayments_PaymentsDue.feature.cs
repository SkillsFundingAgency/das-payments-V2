...
namespace SFA.DAS.Payments.RequiredPayments.AcceptanceTests.Tests.In_ProgressTests.Split_Sample
{
    ...
    [NUnit.Framework.DescriptionAttribute("R03 Payments Due - with multiple historical payment")]
    public partial class R03PaymentsDue_WithMultipleHistoricalPaymentFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "OnTime_Submission_MultipleHistoricalPayments_PaymentsDue.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "R03 Payments Due - with multiple historical payment", null, ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
            ...
            table172.AddRow(new string[] {
                        ...
                        "continuing"});
#line 8
 testRunner.And("the following course information:", ((string)(null)), table172, "And ");
#line hidden
...
#line 12
 testRunner.And("the following contract type 2 on programme earnings for periods 1-12 are provided" +
                    " in the latest ILR for the academic year 1718:", ((string)(null)), table173, "And ");
#line hidden
        }
