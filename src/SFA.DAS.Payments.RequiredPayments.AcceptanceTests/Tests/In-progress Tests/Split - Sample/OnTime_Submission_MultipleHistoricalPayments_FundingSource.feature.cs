...
namespace SFA.DAS.Payments.RequiredPayments.AcceptanceTests.Tests.In_ProgressTests.Split_Sample
{
    ...
    [NUnit.Framework.DescriptionAttribute("R03 Funding Source - with multiple historical payment")]
    public partial class R03FundingSource_WithMultipleHistoricalPaymentFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "OnTime_Submission_MultipleHistoricalPayments_FundingSource.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "R03 Funding Source - with multiple historical payment", null, ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line 8
 testRunner.And("the required payments component generates the following contract type 2 payable e" +
                    "arnings:", ((string)(null)), table170, "And ");
#line hidden
        }
...
#line 21
 testRunner.Then("the payment source component will generate the following contract type 2 coinvest" +
                    "ed payments:", ((string)(null)), table171, "Then ");
#line hidden
