...
#line hidden
            ...
            table163.AddRow(new string[] {
                        ...
                        "Completed"});
#line 15
 testRunner.And("the following course information:", ((string)(null)), table163, "And ");
#line hidden
            ...
            table164.AddRow(new string[] {
                        ...
                        "SEM1"});
#line 20
 testRunner.And("the employment status in the ILR is:", ((string)(null)), table164, "And ");
#line hidden
...
#line 28
 testRunner.And("the following contract type 2 on programme earnings for periods 1-12 are provided" +
                    " in the latest ILR for the academic year 1718:", ((string)(null)), table165, "And ");
#line hidden
...
#line 32
 testRunner.And("the following contract type 2 on programme earnings for period 13 are provided in" +
                    " the latest ILR for the academic year 1718:", ((string)(null)), table166, "And ");
#line hidden
        }
...
#line hidden
            ...
            table167.AddRow(new string[] {
                        ...
                        "1.0000"});
#line 49
 testRunner.And("the following historical contract type 2 on programme payments exist:", ((string)(null)), table167, "And ");
#line 64
...
#line 66
 testRunner.Then("the payments due component will generate the following contract type 2 payable ea" +
                    "rnings:", ((string)(null)), table168, "Then ");
#line hidden
...
#line 89
 testRunner.Then("the payments due component will generate the following contract type 2 payable ea" +
                    "rnings:", ((string)(null)), table169, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
