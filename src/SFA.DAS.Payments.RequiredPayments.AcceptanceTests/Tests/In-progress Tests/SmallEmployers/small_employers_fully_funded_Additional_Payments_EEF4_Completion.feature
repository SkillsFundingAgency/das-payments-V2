...
Feature: Small Employers fully funded additional payments EEF4 Completion
		 AC3- 1 learner aged 19-24, non-DAS, is a care leaver, In paid employment with a small employer at start, is fully funded for On Programme and On Programme Completion payments
...
Background: 
	...
	| PriceEpisodeIdentifier | EpisodeStartDate | EpisodeEffectiveTNPStartDate | TotalNegotiatedPrice | Learning (TT1) | Completion (TT2) |
	| p1                     | 06/08/2017       | 06/08/2017                   | 7500                 | 500        | 1500         | 1.0000                    |
...
#
#@SmallEmployerNonDas
#Scenario:AC3- 1 learner aged 19-24, non-DAS, is a care leaver, In paid employment with a small employer at start, is fully funded for On Programme and On Programme Completion payments
#
##Note: care leavers are flagged on the ILR through EEF code = 4*
#	Given the apprenticeship funding band maximum is 9000
