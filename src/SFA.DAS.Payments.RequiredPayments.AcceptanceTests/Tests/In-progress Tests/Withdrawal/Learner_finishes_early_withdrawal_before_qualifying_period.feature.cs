...
namespace SFA.DAS.Payments.RequiredPayments.AcceptanceTests.Tests.In_ProgressTests.Withdrawal
{
...
#line hidden
            ...
            table182.AddRow(new string[] {
                        ...
                        "withdrawn"});
#line 13
 testRunner.And("the following course information:", ((string)(null)), table182, "And ");
#line hidden
...
#line 17
 testRunner.And("the following contract type 2 on programme earnings for periods 1-12 are provided" +
                    " in the latest ILR for the academic year 1718:", ((string)(null)), table183, "And ");
#line hidden
        }
...
#line 30
 testRunner.And("the following historical contract type 2 on programme payments exist:", ((string)(null)), table184, "And ");
#line 34
...
#line 36
 testRunner.Then("the payments due component will generate the following contract type 2 payable ea" +
                    "rnings:", ((string)(null)), table185, "Then ");
#line hidden
