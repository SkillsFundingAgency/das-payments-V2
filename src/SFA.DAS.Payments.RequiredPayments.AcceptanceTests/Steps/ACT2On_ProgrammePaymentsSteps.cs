    ...
    public class ACT2On_ProgrammePaymentsSteps: StepsBase
    {
        ...
        public void ThenTheServiceShouldGenerateTheRequiredPayments()
        {
            WaitForIt(() =>
            {
                ...
                return periods.All(earningPeriod => ApprenticeshipContractType2Handler.ReceivedEvents.Any(receivedEvent => receivedEvent.Amount == earningPeriod.period.Amount && receivedEvent.Period == earningPeriod.period.Period));
