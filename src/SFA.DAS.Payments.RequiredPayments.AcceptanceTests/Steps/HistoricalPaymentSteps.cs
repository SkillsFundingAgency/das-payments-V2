    ...
    public class HistoricalPaymentSteps : StepsBase
    {
        ...
        private PaymentModel ToPayment(HistoricalPayment payment, FundingSourceType fundingSource)
        {
            ...
            return new PaymentModel
            {
                ...
                CollectionPeriod = Payments.Model.Core.CollectionPeriod.CreateFromAcademicYearAndPeriod(CollectionYear, CollectionPeriod),
                DeliveryPeriod = DeliveryPeriod.CreateFromAcademicYearAndPeriod(CollectionYear, payment.Delivery_Period),
