...
namespace SFA.DAS.Payments.RequiredPayments.Application.Infrastructure.Ioc
{
    public class RequiredPaymentsModule: Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<ApprenticeshipContractType2EarningEventProcessor>().Keyed<IEarningEventHandler>(typeof(ApprenticeshipContractType2PaymentDueEvent));
            builder.RegisterType<FunctionalSkillEarningsEventProcessor>().Keyed<IEarningEventHandler>(typeof(IncentivePaymentDueEvent));
        }
    }
}