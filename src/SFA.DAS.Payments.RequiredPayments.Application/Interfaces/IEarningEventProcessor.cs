...
namespace SFA.DAS.Payments.RequiredPayments.Application
{
    ...
    public interface IApprenticeshipContractType2EarningsEventProcessor : IEarningEventProcessor<ApprenticeshipContractType2EarningEvent>
    {
    }

    public interface IFunctionalSkillEarningsEventProcessor : IEarningEventProcessor<ApprenticeshipContract2TypeFunctionalSkillEarningsEvent>
    {
    }
