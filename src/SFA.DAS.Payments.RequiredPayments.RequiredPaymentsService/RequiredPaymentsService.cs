...
namespace SFA.DAS.Payments.RequiredPayments.RequiredPaymentsService
{
    ...
    public class RequiredPaymentsService : Actor, IRequiredPaymentsService
    {
        ...
        public async Task Initialise()
        {
            ...
            var groupedHistory = paymentHistory.GroupBy(payment => paymentKeyService.GeneratePaymentKey(payment.PriceEpisodeIdentifier, payment.LearnAimReference, payment.TransactionType, new CalendarPeriod(payment.DeliveryPeriod)))
