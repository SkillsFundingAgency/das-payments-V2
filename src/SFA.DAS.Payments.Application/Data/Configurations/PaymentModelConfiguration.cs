...
namespace SFA.DAS.Payments.Application.Data.Configurations
{
    ...
    public class PaymentModelConfiguration : IEntityTypeConfiguration<PaymentModel>
    {
        public void Configure(EntityTypeBuilder<PaymentModel> builder)
        {
            ...
            builder.Property(x => x.RequiredPaymentEventId).HasColumnName(@"RequiredPaymentEventId").IsRequired();
            builder.Property(x => x.ClawbackSourcePaymentId).HasColumnName(@"ClawbackSourcePaymentId").IsRequired();
