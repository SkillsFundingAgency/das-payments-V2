...
namespace SFA.DAS.Payments.DataLocks.Application.Services
{
    ...
    public class ApprenticeshipUpdatedProcessor : IApprenticeshipUpdatedProcessor
    {
        ...
        {
            logger.LogDebug($"Getting apprenticeships cache item using uln for " +
            ...
            logger.LogInfo($"Finished storing the apprenticeship details in the cache. " +
                           $"Apprenticeship id: {model.Id}, Account: {model.AccountId}, Provider: {model.Ukprn}");
