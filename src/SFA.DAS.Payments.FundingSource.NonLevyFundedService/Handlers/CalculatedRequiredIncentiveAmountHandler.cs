...
{
    public class CalculatedRequiredIncentiveAmountHandler : IHandleMessages<CalculatedRequiredIncentiveAmount>
    {
        private readonly IPaymentLogger logger;
        private readonly IExecutionContext executionContext;
        private readonly IIncentiveRequiredPaymentProcessor incentiveProcessor;

        public CalculatedRequiredIncentiveAmountHandler(IPaymentLogger logger,
