...
{
    public class IncentiveRequiredPaymentEventHandler : IHandleMessages<IncentiveRequiredPaymentEvent>
    {
        ...
        public async Task Handle(IncentiveRequiredPaymentEvent message, IMessageHandlerContext context)
        {
            try
            {
