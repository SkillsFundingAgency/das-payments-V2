    ...
    public class FeatureScopedBootstrapper : TestSessionBase
    {
        ...
        public static void AddRoutingConfig()
        {
            ...
            conventions.DefiningEventsAs(type => type.IsEvent<IPaymentsEvent>())
                .DefiningCommandsAs(t => t.IsAssignableTo<ProcessLearnerCommand>() || t.IsAssignableTo<PublishProviderAct1CompletionPaymentsCommand>());
            ...
            routing.RouteToEndpoint(typeof(PublishProviderAct1CompletionPaymentsCommand), EndpointNames.ProviderPayments);
