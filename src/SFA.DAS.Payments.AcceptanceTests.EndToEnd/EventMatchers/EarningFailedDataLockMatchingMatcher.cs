...
{
    public class EarningFailedDataLockMatchingMatcher : BaseMatcher<EarningFailedDataLockMatchingMatcher>
    {
        ...
        public EarningFailedDataLockMatchingMatcher(Provider provider, CollectionPeriod collectionPeriod, TestSession testSession, List<ProviderPayment> paymentSpec = null)
        {
        ...
        protected override IList<EarningFailedDataLockMatchingMatcher> GetActualEvents()
        {
        ...
        protected override IList<EarningFailedDataLockMatchingMatcher> GetExpectedEvents()
        {
            var expectedPayments = new List<EarningFailedDataLockMatchingMatcher>();
        ...
        protected override bool Match(EarningFailedDataLockMatchingMatcher expected, EarningFailedDataLockMatchingMatcher actual)
        {
