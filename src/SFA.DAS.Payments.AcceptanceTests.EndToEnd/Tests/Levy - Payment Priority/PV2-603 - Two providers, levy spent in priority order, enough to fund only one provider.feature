...
Scenario Outline: Two providers, levy available for only one provider, spent in priority order - PV2-603
	...
	And the "provider a" is providing training for the following learners
		...
		| learner a  | 01/Aug/Current Academic Year | 12 months        | 15000                | 01/Aug/Current Academic Year        |                        |                                       |                 | continuing        | Act1          | 1                   | ZPROG001      | 593            | 1            | 20             | 19+ Apprenticeship (From May 2017) Levy Contract | 90%                         |
