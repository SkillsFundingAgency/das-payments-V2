Feature:  Levy learner changes provider but remains with the same employer and ILR changes after the new commitment PV2-320
	As a provider,
	I want a levy learner, that changes provider but remains with the same employer, ILR changes after the new commitment is in place to be paid the correct amount
	So that I am accurately paid my apprenticeship provision.

Scenario Outline: Levy learner changes provider but remains with the same employer and ILR changes after the new commitment PV2-320
	...
	And the following commitments exist
        ...
        | 1             | 1-001      | provider a | 01/Aug/Current Academic Year | 01/Aug/Next Academic Year | 7500         | cancelled | 01/Aug/Current Academic Year | 04/Mar/Current Academic Year | 05/Mar/Current Academic Year |
        | 2             | 1-001      | provider b | 05/Mar/Current Academic Year | 01/Aug/Next Academic Year | 4500         | active    | 05/Mar/Current Academic Year |                              |                              |
    ...
    But the "provider a" now changes the Learner details as follows
		| Start Date                   | Planned Duration | Total Training Price | Total Training Price Effective Date | Total Assessment Price | Total Assessment Price Effective Date | Actual Duration | Completion Status | Contract Type | Aim Sequence Number | Aim Reference | Standard Code | Programme Type | Funding Line Type                                  | SFA Contribution Percentage |
		| 06/Aug/Current Academic Year | 12 months        | 6000                 | 06/Aug/Current Academic Year        | 1500                   | 06/Aug/Current Academic Year          | 8 months        | withdrawn         | Act1          | 1                   | ZPROG001      | 51            | 25             | 19-24 Apprenticeship (From May 2017) Levy Contract | 90%                         |
	
	And the "provider b" is providing training for the following learners
		| Start Date                   | Planned Duration | Total Training Price | Total Training Price Effective Date | Total Assessment Price | Total Assessment Price Effective Date | Actual Duration | Completion Status | Contract Type | Aim Sequence Number | Aim Reference | Standard Code | Programme Type | Funding Line Type                                  | SFA Contribution Percentage |
		| 05/Apr/Current Academic Year | 4 months         | 3000                 | 05/Apr/Current Academic Year        | 1500                   | 05/Apr/Current Academic Year          |                 | continuing        | Act1          | 1                   | ZPROG001      | 51            | 25             | 19-24 Apprenticeship (From May 2017) Levy Contract | 90%                         |
	...
	And only the following "provider b" payments will be recorded
        | Collection Period         | Delivery Period           | Levy Payments | Transaction Type |
		| R09/Current Academic Year | Apr/Current Academic Year | 900           | Learning         |
		| R10/Current Academic Year | May/Current Academic Year | 900           | Learning         |
		| R11/Current Academic Year | Jun/Current Academic Year | 900           | Learning         |
		| R12/Current Academic Year | Jul/Current Academic Year | 900           | Learning         |        
...
Examples: 
        ...
        | R10/Current Academic Year | 7100         |
        | R11/Current Academic Year | 6200         |
        | R12/Current Academic Year | 5300         |