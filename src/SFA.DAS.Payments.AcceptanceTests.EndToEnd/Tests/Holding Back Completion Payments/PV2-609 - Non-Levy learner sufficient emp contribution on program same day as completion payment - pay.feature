...
Scenario Outline: Non-Levy learner, sufficient employer contribution, on program payment same day as completion payment - pay completion PV2-609
    ...
    But the Provider now changes the Learner details as follows
		...
		| 01/Jun/Last Academic Year | 12 months        | 9000                 | 01/Jun/Last Academic Year           | 0                      |                                       | 12 months       | completed         | Act2          | 1                   | ZPROG001      | 593            | 1            | 20             | 19+ Apprenticeship Non-Levy Contract (procured) | 90%                         | 720                   |
	...
	Then the following learner earnings should be generated
		...
		| May/Current Academic Year | 600          | 1800       | 0         | pe-1                     |
...
# 
#Scenario: AC18 - 1 learner, Non-levy, final on program payment is same day as completion payment, provider data shows enough employer contribution – pay completion
#
...
#        | learner a | programme only non-DAS | 9000         | 06/06/2018 | 08/06/2019       | 30/05/2019      | completed         | 720					   |
#
...
#		| SFA non-Levy co-funding budget          | 540   | 540   | 540   | ... | 540   | 2160  | 0     | 
