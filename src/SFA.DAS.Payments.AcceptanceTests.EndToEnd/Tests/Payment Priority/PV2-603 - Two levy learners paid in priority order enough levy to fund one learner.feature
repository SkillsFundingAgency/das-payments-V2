...
Scenario Outline: Two levy learners, levy available but for only one learner, levy spent in priority order PV2-603
	...
	And the following commitments exist
        ...
        | learner a  | 1        | 01/Aug/Current Academic Year | 08/Sep/Current Academic Year | 15000        |
        | learner b  | 2        | 01/Aug/Current Academic Year | 08/Sep/Current Academic Year | 15000        |
