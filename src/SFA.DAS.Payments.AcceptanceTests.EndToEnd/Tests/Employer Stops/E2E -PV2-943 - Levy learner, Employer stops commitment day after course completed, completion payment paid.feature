...
#
#Scenario: Employer stops commitment after the day that the course is completed, but in the same month. Completion payment to be paid
#  
...
#        | Type                           | 08/18 | 09/19 | ... | 07/19 | 08/19 | 09/19 |
...
Feature: Employer Stops PV2-943
Scenario Outline: Employer stops commitment after the day that the course is completed, but in the same month. Completion payment to be paid
