...
#
#Scenario: Levy learner, Employer stops commitment before the day that the course is completed, but in the same month. Completion not paid
#
...
#        | Provider Earned from SFA       | 1000  | 1000  | ... | 1000  | 0     | 0     |
...
Feature: Employer Stops PV2-945

Scenario Outline: Levy learner, Employer stops commitment before the day that the course is completed, but in the same month. Completion not paid
...
Given the employer levy account balance in collection period <Collection_Period> is <Levy Balance>
	...
	And the following apprenticeships exist
		...
		| 593            | 20             | 1            | 15000        | 06/Aug/Last Academic Year | 01/Sep/Current Academic Year | stopped | 06/Aug/Last Academic Year | 05/Aug/Current Academic Year |		
