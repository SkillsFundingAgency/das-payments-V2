Feature: Inconsistent Submissions Data PV2-1625

Scenario: Levy learner a is deleted from ILR in 07/18, but Levy learner b is added to the 07/18 ILR PV2-1625	
    ...
    And at month end only the following payments will be calculated
        ...
        | learner a  | R12/Current Academic Year | May/Current Academic Year | -600         | -500       | -1000     |
        | learner a  | R12/Current Academic Year | Jun/Current Academic Year | -600         | -500       | -1000     |
