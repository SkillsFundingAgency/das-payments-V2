Feature: PV2-2094-3-correctly-refund-duplicate-payment-claw-backs-when-a-learner-is-added-back-into-ILR
Scenario: PV2-2094-3 correctly refund duplicate payment claw backs when a learner is added back into ILR
...
When following provider payments exists in database For period R11
...
# previously system was generating duplicate refund this records simulates that incorrect behaviour
    | learner b  | R11/Current Academic Year | Jan/Current Academic Year | -600          | Learning         |
...
And After Period-end following provider payments will be generated in database
    | Learner ID | Collection Period         | Delivery Period           | Levy Payments | Transaction Type |
    | learner a  | R12/Current Academic Year | Jul/Current Academic Year | 600           | Learning         |
...
# this proves that duplicate refund is corrected
    | learner b  | R12/Current Academic Year | Jan/Current Academic Year | 1200          | Learning         |
