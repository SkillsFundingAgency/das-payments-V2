@ignore
	Feature:Learner changes employer - and there is a gap in the commitments 
	As a provider,
	...
	Scenario Outline: Provider earnings and payments where learner changes employer and there is a gap between commitments - provider receives payment during the gap as they amend the ACT code and employment status code correctly. PV2-375
