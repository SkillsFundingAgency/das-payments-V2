@ignore
Feature: One Levy Learner, no payment if commitment has gap while changing employers and no change employment status specified PV2-378
		As a provider,
...
Scenario Outline: One Levy Learner, no payment if commitment has gap while changing employers and no change employment status specified PV2-378
    ...
    And at month end only the following payments will be calculated
        ...
        | R03/Current Academic Year | Oct/Current Academic Year | 900          | 0          | 0         |
