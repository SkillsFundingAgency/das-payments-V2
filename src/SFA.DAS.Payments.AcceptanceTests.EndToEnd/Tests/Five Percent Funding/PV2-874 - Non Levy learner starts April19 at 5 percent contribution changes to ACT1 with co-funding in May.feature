...
#        | Provider 16-18 incentive     | 0     | 0     | 0     | 0     |
 ...
 Scenario: Non Levy Learner, starts new learning April 2019, five percent contribution, changes to ACT1 in the following month, learner is co-funded as not enough levy in the account PV2-874
	...
	And the following provider payments had been generated
		...
		| R04/Current Academic Year | Apr/Current Academic Year | 950                    | 50                          | Learning         | Act2          |
	...
	But the Provider now changes the Learner details as follows
		...
		| 01/Apr/Current Academic Year | 12 months        | 15000                | 01/Apr/Current Academic Year        |                        |                                       | 1 month         | Active            | 1                   | ZPROG001      | 593            | 1            | 20             | 19-24 Apprenticeship (From May 2017) Levy Contract | 95%                         |
    ...
    And at month end only the following payments will be calculated
        ...
        | R10/Current Academic Year | May/Current Academic Year | 1000         | 0          | 0         | Act1          |

	And only the following provider payments will be recorded
        | Collection Period         | Delivery Period           | SFA Co-Funded Payments | Employer Co-Funded Payments | Transaction Type | Contract Type |
        | R12/Current Academic Year | Jul/Current Academic Year | 950                    | 50                          | Learning         | Act1          |
