...
Given "provider a" previously submitted the following learner details
	...
	But the Learner has now changed to "provider b" as follows
		| Start Date                   |OriginalStartDate            | Planned Duration | Total Training Price | Total Training Price Effective Date | Total Assessment Price | Total Assessment Price Effective Date | Actual Duration | Completion Status | Contract Type | Aim Sequence Number | Aim Reference | Standard Code | Programme Type | Funding Line Type                               | SFA Contribution Percentage | Employer      | 
		| 05/Apr/Current Academic Year |06/Aug/Current Academic Year | 4 months         | 3200                 | 05/Apr/Current Academic Year        | 800                    | 05/Apr/Current Academic Year          |                 | continuing        | Act2          | 1                   | ZPROG001      | 52            | 25             | 19+ Apprenticeship Non-Levy Contract (procured) | 90%                         | Test Employer | 
