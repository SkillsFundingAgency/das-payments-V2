...
Scenario: PV2-688 - New Apprenticeship Approved
	...
	And the following apprenticehsips have been approved
		| Idenifier        | Created On Date              | Agreed On Date               | Learner   | Provider   | Employer   | Sending Employer | Standard Code | Programme Type | Framework Code | Pathway Code | Start date                   | End date                     |
