Feature: DLOCK07 - When no matching record found in an employer digital account for the agreed price then datalock DLOCK_07 will be produced PV2-667
		As a Provider,
		I want to be notified with a DLOCK07 when no matching record found in an employer digital account for the agreed price
		So that I can correct the data mis-match between the Commitment and ILR - PV2-667

Scenario Outline: DLOCK07 - When no matching record found in an employer digital account for the agreed price then datalock DLOCK_07 will be produced PV2-667
...
Given the employer levy account balance in collection period R12/Current Academic Year is 10000 
	And the following commitments exist
		...
		| Apprenticeship a | 593            | 20             | 1            | 10000        | 01/Aug/Current Academic Year | 01/May/Next Academic Year | active | 01/Aug/Current Academic Year |				
	And the provider is providing training for the following learners
		...
		| 01/Aug/Current Academic Year | 12 months        | 10010                | 01/Aug/Current Academic Year        | continuing        | Act1          | 1                   | ZPROG001      | 593            | 20             | 1            | 16-18 Apprenticeship (From May 2017) Levy Contract | 90%                         |
    And price details as follows
		| Price Episode Id  | Total Training Price | Total Training Price Effective Date | Contract Type  | SFA Contribution Percentage |
		| pe-1              | 10010                | 01/Aug/Current Academic Year        | Act1           | 90%                         |
	...
	And the following data lock failures were generated
        ...
        | Apprenticeship a | Aug/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
		| Apprenticeship a | Sep/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
		| Apprenticeship a | Oct/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
		| Apprenticeship a | Nov/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
		| Apprenticeship a | Dec/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
		| Apprenticeship a | Jan/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
		| Apprenticeship a | Feb/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
		| Apprenticeship a | Mar/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
		| Apprenticeship a | Apr/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_07   | pe-1                     |
...
#Scenario: DLOCK07 - When no matching record found in an employer digital account for the agreed price then datalock DLOCK_07 will be produced
#    
...
#        | Provider a | learner a | 450            | 2              | 1            | 01/05/2018 | 08/08/2019       | continuing        | 10010                | 01/05/2018                          |
#    
...
#        | 2-450-1-01/05/2018        | 73                | learner a | 01/05/2018     | 10010              |
#        
#	And the data lock event has the following errors:    
#        | Price Episode identifier  | Error code | Error Description										|
#        | 2-450-1-01/05/2018        | DLOCK_07   | No matching record found in the employer digital account for the negotiated cost of training	|
#        
