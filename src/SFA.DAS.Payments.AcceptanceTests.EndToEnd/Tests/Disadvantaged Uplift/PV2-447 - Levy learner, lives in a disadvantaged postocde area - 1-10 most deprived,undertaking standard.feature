...
#Scenario: Payment for a DAS learner, lives in a disadvantaged postocde area - 1-10% most deprived, undertaking apprenticeship standard - Disadvantage Uplift is not paid
#    Given levy balance > agreed price for all months
#    And the following commitments exist:
#        | commitment Id | version Id | ULN       | start date | end date   | standard code | agreed price | status |
#        | 1             | 1-001      | learner a | 01/08/2018 | 01/08/2019 | 50            | 15000        | active |
...
#        | learner a | programme only DAS | 15000        | 06/08/2018 | 08/08/2019       |                 | continuing        | 50            | 1-10%                     |
#    Then the provider earnings and payments break down as follows:
#        | Type                                    | 08/18 | 09/18 | 10/18 | 11/18 | 12/18 | ... | 07/19 | 08/19 | 09/19 |
#        | Provider Earned Total                   | 1000  | 1000  | 1000  | 1000  | 1000  | ... | 1000  | 0     | 0     |
#		| Provider Earned from SFA                | 1000  | 1000  | 1000  | 1000  | 1000  | ... | 1000  | 0     | 0     |        
...
Feature: Payment for a DAS learner, lives in a disadvantaged postocde area - 1-10% most deprived, undertaking apprenticeship standard - Disadvantage Uplift is not paid
		As a provider,
		I want a levy learner living in a Disadvantaged Postcode area (1-10% most deprived) to undertake an Apprenticeship Standard course
		So that I am not paid the Disadvantage Uplift payment.
Scenario Outline: Levy learner, on standard, Disadvantage Uplift 1-10% not paid PV2-447
