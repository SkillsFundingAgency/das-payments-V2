    ...
    public class SubmissionWindowValidationService : ISubmissionWindowValidationService
    {
        ...
        private void SendTelemetry(SubmissionsSummaryModel metrics, long reportGenerationDuration)
        {
            ...
            var stats = new Dictionary<string, double>
            {
                ...
                { "DataLockedCountDLock1",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock1 },
                { "DataLockedCountDLock2",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock2 },
                { "DataLockedCountDLock3",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock3 },
                { "DataLockedCountDLock4",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock4 },
                { "DataLockedCountDLock5",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock5 },
                { "DataLockedCountDLock6",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock6 },
                { "DataLockedCountDLock7",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock7 },
                { "DataLockedCountDLock8",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock8 },
                { "DataLockedCountDLock9",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock9 },
                { "DataLockedCountDLock10",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock10 },
                { "DataLockedCountDLock11",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock11 },
                { "DataLockedCountDLock12",     metrics.DataLockMetricsTotals.Single().Amounts.DataLock12 }
            };
