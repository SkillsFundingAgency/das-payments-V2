...
namespace SFA.DAS.Payments.Monitoring.JobsProxyService
{
    [EventSource(Name = "MyCompany-SFA.DAS.Payments.Monitoring.ServiceFabric-SFA.DAS.Payments.Monitoring.JobsProxyService")]
