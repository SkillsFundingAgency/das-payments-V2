Create TABLE [Jobs].[Job]( 
	...
	JobType TINYINT NOT NULL CONSTRAINT FK_Job__JobType FOREIGN KEY REFERENCES [Jobs].[JobType] (Id),
	StartTime DATETIMEOFFSET NOT NULL CONSTRAINT DF_Job__StartTime DEFAULT (SYSDATETIMEOFFSET()),	
	EndTime DATETIMEOFFSET NULL, 
	[Status] TINYINT NOT NULL CONSTRAINT FK_Job__JobStatus FOREIGN KEY REFERENCES [Jobs].[JobStatus] (Id) CONSTRAINT DF_Job__Status DEFAULT (1),
	...
	INDEX IX_Job__DCJobId_Ukprn NONCLUSTERED (JobId, DCJobId, Ukprn)
)

GO

CREATE INDEX [IX_Job__Search] ON [Jobs].[Job](
	JobId,
	JobType,
	DCJobId,
	Ukprn,
