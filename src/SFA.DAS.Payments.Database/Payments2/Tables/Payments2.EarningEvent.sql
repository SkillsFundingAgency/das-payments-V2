...
(
	Id BIGINT NULL, -- IDENTITY(1,1) CONSTRAINT PK_EarningEvent PRIMARY KEY CLUSTERED,
	EventId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_EarningEvent PRIMARY KEY CLUSTERED, 
