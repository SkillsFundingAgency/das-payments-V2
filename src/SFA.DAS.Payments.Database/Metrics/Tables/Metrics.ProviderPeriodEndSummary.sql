CREATE TABLE [Metrics].[ProviderPeriodEndSummary] (
    ...
    [AdjustedDataLockedEarnings16To18]        DECIMAL (15, 5)    CONSTRAINT [DF_ProviderPeriodEndSummary__AdjustedDataLockedEarnings16To18] DEFAULT ((0)) NOT NULL,
    [AdjustedDataLockedEarnings19Plus]        DECIMAL (15, 5)    CONSTRAINT [DF_ProviderPeriodEndSummary__AdjustedDataLockedEarnings19Plus] DEFAULT ((0)) NOT NULL,
