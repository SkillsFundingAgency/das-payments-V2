create table Metrics.ProviderEarning(
	...
	,SubmissionId  bigint not null constraint FK_ProviderEarning__Submission_Id foreign key references [Metrics].[Submission] (Id) on delete cascade
	...
	,Index IX_ProviderEarning (SubmissionId, EarningsType, ContractType, CreationDate)
)
