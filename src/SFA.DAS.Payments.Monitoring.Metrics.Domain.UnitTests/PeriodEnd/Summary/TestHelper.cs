...
namespace SFA.DAS.Payments.Monitoring.Metrics.Domain.UnitTests.PeriodEnd.Summary
{
    class TestHelper
    {
        ...
        public static ProviderFundingLineTypeAmounts DefaultDataLockedTotal => new ProviderFundingLineTypeAmounts{ FundingLineType19PlusAmount = 1000, FundingLineType16To18Amount = 3000, Ukprn = DefaultPeriodEndProviderSummary.Ukprn };
