...
namespace SFA.DAS.Payments.Monitoring.Metrics.Domain.UnitTests.PeriodEnd.Summary
{
    class TestHelper
    {
        ...
        public static List<ProviderLearnerNegativeEarningsDataLockFundingLineTypeAmounts> DefaultLearnerDataLockedEarnings() => new List<ProviderLearnerNegativeEarningsDataLockFundingLineTypeAmounts>();
