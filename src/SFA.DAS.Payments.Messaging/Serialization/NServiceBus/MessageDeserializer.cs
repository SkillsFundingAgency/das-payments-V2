...
namespace SFA.DAS.Payments.Messaging.Serialization.NServiceBus
{
    public class MessageDeserializer: IMessageDeserializer
    {
        ...
        {
            if (!message.UserProperties.ContainsKey(global::NServiceBus.Headers.EnclosedMessageTypes))
            ...
            var enclosedTypes = (string)message.UserProperties[global::NServiceBus.Headers.EnclosedMessageTypes];
