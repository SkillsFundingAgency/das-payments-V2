...
{
    [TestFixture]
    public class DasLevyAccountBalanceApiWrapperTests
    {
        private DasLevyAccountBalanceApiWrapper sut;
        ...
        public void SetUp()
        {
            ...
            sut = mocker.Create<DasLevyAccountBalanceApiWrapper>(new NamedParameter("accountApiBatchSize", 1000));
        }
        ...
        [Test]
        public async Task When_GetLevyAccountDetails_Throws_Error_GetDasLevyAccountDetails_Should_Return_EmptyList()
        {
            accountApiClient
