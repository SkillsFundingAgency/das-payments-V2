...
{
    public class FunctionalSkillsEarningValueResolver : IValueResolver<IntermediateLearningAim, ApprenticeshipContractTypeFunctionalSkillEarningsEvent, ReadOnlyCollection<FunctionalSkillEarning>>
    {
        ...
        public ReadOnlyCollection<FunctionalSkillEarning> Resolve(IntermediateLearningAim source, ApprenticeshipContractTypeFunctionalSkillEarningsEvent destination, ReadOnlyCollection<FunctionalSkillEarning> destMember, ResolutionContext context)
        {
