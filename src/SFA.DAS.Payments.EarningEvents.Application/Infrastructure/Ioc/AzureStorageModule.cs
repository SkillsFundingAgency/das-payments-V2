    ...
    public class AzureStorageModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            builder.Register(c =>
            {
                ...
                return new AzureStorageKeyValuePersistenceConfig(configHelper.GetConnectionString("AzureTableStorageConnectionString"),
                    configHelper.GetSetting("DcTableStorageContainer"));
