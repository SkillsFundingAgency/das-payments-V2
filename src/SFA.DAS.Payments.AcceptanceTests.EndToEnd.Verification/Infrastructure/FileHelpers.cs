   ...
   public static class FileHelpers
    {
        ...
        public static async Task UploadCsvFile(ReportType reportType, short academicYear, byte collectionPeriod, ISubmissionService submissionService,
            string csvString)
        {
            var fileName = FileHelpers.CreateCsvFileName(academicYear, collectionPeriod, reportType);
