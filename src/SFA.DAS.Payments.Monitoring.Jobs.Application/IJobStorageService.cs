...
namespace SFA.DAS.Payments.Monitoring.Jobs.Application
{
    public interface IJobStorageService
    {
        ...
        Task SaveJobStatus(long jobId, JobStatus jobStatus, DateTimeOffset endTime,
        ...
        Task StoreInProgressMessages(long jobId, List<InProgressMessage> inProgressMessages,
            CancellationToken cancellationToken);
        ...
        Task<(bool hasFailedMessages, DateTimeOffset? endTime)> GetJobStatus(long jobId,
            CancellationToken cancellationToken);

        Task StoreJobStatus(long jobId, bool hasFailedMessages, DateTimeOffset? endTime,
            CancellationToken cancellationToken);
        ...
        Task<List<long>> GetCurrentPeriodEndFcsHandoverJobs(CancellationToken cancellationToken);
