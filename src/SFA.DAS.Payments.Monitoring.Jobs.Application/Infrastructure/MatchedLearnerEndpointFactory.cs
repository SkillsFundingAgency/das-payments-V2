...
{
    public interface IMatchedLearnerEndpointFactory
    {
        Task<IEndpointInstance> GetEndpointInstanceAsync();
    }

    public class MatchedLearnerEndpointFactory : IMatchedLearnerEndpointFactory
    {
        ...
        public MatchedLearnerEndpointFactory(IConfigurationHelper configHelper, IApplicationConfiguration config, IPaymentLogger logger, ILifetimeScope lifetimeScope)
        {
        ...
        private EndpointConfiguration CreateEndpointConfiguration()
        {
            ...
            conventions.DefiningEventsAs(t => t.IsAssignableTo<SubmissionFinishedEvent>());
            ...
            transport.ConnectionString(configHelper.GetConnectionString("MatchedLearnerServiceBusConnectionString"))
