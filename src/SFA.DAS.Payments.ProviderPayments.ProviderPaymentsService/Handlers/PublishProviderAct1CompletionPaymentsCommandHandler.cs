...
{
    public class PublishProviderAct1CompletionPaymentsCommandHandler : IHandleMessageBatches<PublishProviderAct1CompletionPaymentsCommand>
    {
        ...
        public PublishProviderAct1CompletionPaymentsCommandHandler(IDasEndpointFactory dasEndpointFactory, IPaymentLogger paymentLogger, ICompletionPaymentService completionPaymentService)
        {
        ...
        public async Task Handle(PublishProviderAct1CompletionPaymentsCommand message, CancellationToken cancellationToken)
        {
            paymentLogger.LogDebug($"Processing Provider Month End Act1 Completion Payment Command with ukprn: {message.Ukprn}, Message: {message.CollectionPeriod.AcademicYear}-R{message.CollectionPeriod:00}");
        ...
        public async Task Handle(IList<PublishProviderAct1CompletionPaymentsCommand> messages, CancellationToken cancellationToken)
        {
