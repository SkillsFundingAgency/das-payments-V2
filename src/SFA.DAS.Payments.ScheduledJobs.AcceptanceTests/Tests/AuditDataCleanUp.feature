...
Scenario: upon Audit Data Cleanup Schedule Function is executed, New TimedOut Submission Audit Data are NOT deleted
	...
	And Submission B has status TimedOut from collection period 1
...
Scenario: upon Audit Data Cleanup Schedule Function is executed, Old TimedOut Submission Audit Data are NOT deleted
	Given a Provider has done two submissions, First Submission A and Second Submission B
	And Submission A has status TimedOut from collection period 1
	And Submission B has status Completed from collection period 1
	When Audit Data Cleanup Function is executed
	Then Submission A and Submission B Both NOT deleted
...
Scenario: upon Audit Data Cleanup Schedule Function is executed, Old InProgress Submission Audit Data are NOT deleted
	Given a Provider has done two submissions, First Submission A and Second Submission B
	And Submission A has status InProgress from collection period 1
	And Submission B has status Completed from collection period 1
	When Audit Data Cleanup Function is executed
	Then Submission A and Submission B Both NOT deleted
...
Scenario: upon Audit Data Cleanup Schedule Function is executed, Old CompletedWithErrors Submission Audit Data is deleted
	Given a Provider has done two submissions, First Submission A and Second Submission B
	And Both Submission has status CompletedWithErrors in collection period 1
	When Audit Data Cleanup Function is executed
	Then Submission A is deleted
...
Scenario: upon Audit Data Cleanup Schedule Function is executed, Only Completed Submission Audit Data is deleted
	...
	And Now does two new submissions, First Submission B and Second Submission C in collection period 1
	And Now does two new submissions, First Submission D and Second Submission E in collection period 1
	And Submission A has status DcTasksFailed from collection period 1
	And Submission B has status TimedOut from collection period 1
	And Submission C has status CompletedWithErrors from collection period 1
	And Submission D has status Completed from collection period 1
	And Submission E has status InProgress from collection period 1
	When Audit Data Cleanup Function is executed
	Then Submission A is NOT deleted from collection period 1
	And Submission B is NOT deleted from collection period 1
	And Submission C is deleted
	And Submission D is NOT deleted from collection period 1
	And Submission E is NOT deleted from collection period 1

Scenario: upon Audit Data Cleanup Schedule Function is executed, No Submission Audit Data are deleted for multiple Periods
	Given a Provider has done one submissions, Submission C in collection period 1
	And Now does two new submissions, First Submission B and Second Submission A in collection period 2
	...
	And Submission B is NOT deleted from collection period 2
	And Submission C is NOT deleted from collection period 1
