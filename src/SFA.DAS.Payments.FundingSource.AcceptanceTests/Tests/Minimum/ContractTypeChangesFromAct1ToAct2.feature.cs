...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Contract Type Changes From ACT1 To ACT2", "DPP_965_02 - Non-Levy apprentice, provider edits contract type (ACT) in the ILR, " +
                    ...
                    "g to latest contract type", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
            ...
            table2.AddRow(new string[] {
                        ...
                        "-600"});
#line 13
 testRunner.And("the payments due component generates the following contract type 1 on program ear" +
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Contract Type 1 Learning payment", new string[] {
                        "DAS",
                        "minimum_tests",
