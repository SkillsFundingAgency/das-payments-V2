...
Background:
	...
	| learnref1      | 10000 | p1                     | 14     | 10000 | Completion (TT2)| 1800   |
...
Scenario: Contract Type 2 On Programme Completion payment
	...
	| learnref1      | 10000 | p1                     | 14     | 10000 | Completion (TT2)| CoInvestedSfa (FS2)		| 1620   |
	| learnref1      | 10000 | p1                     | 14     | 10000 | Completion (TT2)| CoInvestedEmployer (FS3)	| 180    |
