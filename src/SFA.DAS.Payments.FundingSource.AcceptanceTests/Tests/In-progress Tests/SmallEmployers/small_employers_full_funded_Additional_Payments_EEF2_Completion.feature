...
Feature: Small_Employers fully funded additional payments EEF2 Completion
		 AC2- 1 learner aged 19-24, non-DAS, with an Education Health Care (EHC) plan, In paid employment with a small employer at start, is fully funded for On Programme and On Programme Completion payments
...
Background: 
	...
	| p1                     | 13     | 10000 | Completion (TT2)| 1500   | 1.0000                    |
...
Scenario: Contract Type 2 On Programme Completion payment
	...
	| learnref1      | 10000 | p1                     | 13     | 10000 | Completion (TT2)| CoInvestedSfa (FS2)  | 1500   |
...
#
#@SmallEmployerNonDas
#Scenario:AC2- 1 learner aged 19-24, non-DAS, with an Education Health Care (EHC) plan, In paid employment with a small employer at start, is fully funded for On Programme and On Programme Completion payments
##Note: EHC plans are flagged on the ILR through Eligibility for Enhanced Funding (EEF) code = 2*
#	Given the apprenticeship funding band maximum is 9000
