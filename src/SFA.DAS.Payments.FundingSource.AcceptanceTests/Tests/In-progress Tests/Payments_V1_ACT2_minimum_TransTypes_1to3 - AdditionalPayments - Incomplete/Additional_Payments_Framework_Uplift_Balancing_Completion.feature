...
Background:
	...
	| p1                     | 13     | 10000 | Balancing (TT3) | 1440   |
...
Scenario: Contract Type 2 On Programme Balancing payment
	...
	Then the payment source component will generate the following contract type 2 coinvested payments:
	| LearnRefNumber | Ukprn | PriceEpisodeIdentifier | Period | ULN   | TransactionType | FundingSource        | Amount |
	| learnref1      | 10000 | p1                     | 13     | 10000 | Balancing (TT3) | CoInvestedSfa (FS2)  | 1296   |
	| learnref1      | 10000 | p1                     | 13     | 10000 | Balancing (TT3) | CoInvestedEmployer (FS3)| 144    |
