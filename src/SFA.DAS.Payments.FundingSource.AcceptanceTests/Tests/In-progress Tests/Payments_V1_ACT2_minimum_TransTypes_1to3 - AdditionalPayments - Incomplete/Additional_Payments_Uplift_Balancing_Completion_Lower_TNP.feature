...
Background:
	...
	| p1                     | 13     | 10000 | Completion (TT2)| 1500   |
	| p1                     | 13     | 10000 | Balancing (TT3) | 1200   |
...
Scenario: Contract Type 2 On Programme Completion payment
	...
	| learnref1      | 10000 | p1                     | 13     | 10000 | Completion (TT2)| CoInvestedSfa (FS2)  | 1350   |
	| learnref1      | 10000 | p1                     | 13     | 10000 | Completion (TT2)| CoInvestedEmployer (FS3)| 150    |
...
Scenario: Contract Type 2 On Programme Balancing payment
	...
	| LearnRefNumber | Ukprn | PriceEpisodeIdentifier | Period | ULN   | TransactionType | FundingSource        | Amount |
	| learnref1      | 10000 | p1                     | 13     | 10000 | Balancing (TT3) | CoInvestedSfa (FS2)  | 1080   |
	| learnref1      | 10000 | p1                     | 13     | 10000 | Balancing (TT3) | CoInvestedEmployer (FS3)| 120    |
