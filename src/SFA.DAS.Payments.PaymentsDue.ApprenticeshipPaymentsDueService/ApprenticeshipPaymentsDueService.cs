...
namespace SFA.DAS.Payments.PaymentsDue.ApprenticeshipPaymentsDueService
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of ApprenticeshipPaymentsDueService
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        Task<int> IApprenticeshipPaymentsDueService.GetCountAsync(CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        Task IApprenticeshipPaymentsDueService.SetCountAsync(int count, CancellationToken cancellationToken)
        {
